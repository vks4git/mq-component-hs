...
import           System.MQ.Protocol     (Secure (..), createMessage, emptyId,
                                         notExpires)
...
radioSpeaker Env{..} = do
    ...
    forever $ do
        msg <- createMessage emptyId creator notExpires NotSecured $ RadioData "Good morning, Vietnam! This is example_radio-speaker-hs!"
